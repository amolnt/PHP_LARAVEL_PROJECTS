...
{	    /******************************Send Password Reset Ling to email************************************************/
   	public function sendLink(Request $request){
   		if(count(Input::all())<=0){
            return redirect()->back();
   		}
     		$rad=substr(str_shuffle(str_repeat('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ', 16)), 0, 28);//Random token generate and set session
      ...
      /***********************in email to click on link then showing reset page*************************************/
