              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <div class="">
                          <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action to-do">
                              <thead>
                                <tr>
                                  <th></th>
                              ...
                              <tbody>
                                ...
                                <?php
                                    for($i=0;$i<count($task);$i++){
                                        echo "<tr>";
                                        if($task[$i]['status']=='Assign')
                                          echo '<th><input type="checkbox" id="check-all" class="flat"></th>';
                                        else
                                          echo '<th><input type="checkbox" id="check-all" class="flat" checked></th>';
