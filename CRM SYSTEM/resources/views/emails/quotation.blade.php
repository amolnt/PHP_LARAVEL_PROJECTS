    ...
    <div style="overflow-x:auto;" class="m-b-md">
        <table fram="box" border="1">
            ...
            <tr>
                ...
                <td colspan="6"><p>
                Valid Date:@if(isset($data)){{$data[0]['valid_date']}}@endif<br>
                Quotation No:@if(isset($data)){{$data[0]['qtn']}}@endif</p></td>
            </tr>
            <tr class="theads">
            ...
            <p style="white-space: pre-line;">@if(isset($data)){{$data[0]['term_details']}}@endif</p></td>
            </tr>
            <tr>
